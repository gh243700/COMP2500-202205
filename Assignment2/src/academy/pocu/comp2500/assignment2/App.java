...
public class App {
    public App(Registry registry) {
        ...
        registry.registerLandscapeBannerImageApertureAdder("CustomizableProduct", "addImageAperture");
        registry.registerPortraitBannerTextApertureAdder("CustomizableProduct", "addTextAperture");
        registry.registerPortraitBannerImageApertureAdder("CustomizableProduct", "addImageAperture");
        registry.registerGlossBannerTextApertureAdder("CustomizableProduct", "addTextAperture");
        registry.registerGlossBannerImageApertureAdder("CustomizableProduct", "addImageAperture");
        registry.registerScrimBannerTextApertureAdder("CustomizableProduct", "addTextAperture");
        registry.registerScrimBannerImageApertureAdder("CustomizableProduct", "addImageAperture");
        registry.registerMeshBannerTextApertureAdder("CustomizableProduct", "addTextAperture");
        registry.registerMeshBannerImageApertureAdder("CustomizableProduct", "addImageAperture");
