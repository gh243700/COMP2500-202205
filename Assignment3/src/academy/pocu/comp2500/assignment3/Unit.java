...
public abstract class Unit {
    ...
    public Unit(int hp, char symbol, UnitType unitType, int fov, int aoe, int ap, AttackableUnitType attackableUnitType, IntVector2D position, boolean isThinkable, boolean isMovable) {
        this.hp = hp;
        this.symbol = symbol;
